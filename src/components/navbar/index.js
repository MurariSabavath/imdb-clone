    ...
    <>
      <Container>
        <SideNav style={{ width: `${width}` }}>
          ...
          <Break />
          <Break />
          <Link href="#" padding="10px 20px" margin="0">
            <SVG
              margin="0px 10px"
        ...
        <Section>
          ...
          <Input type="search" placeholder="Search IMDb" onKeyUp={handleForm} />
          <Link href="#" padding="10px 15px" display="none">
            IMDbPro
          </Link>
          <Link href="#" padding="8px 15px" display="none">
            <SVG
              width="24"
              height="24"
              xmlns="http://www.w3.org/2000/svg"
          ...
          <Link href="/signin" padding="10px 15px">
            Sign In
          </Link>
        </Section>
      </Container>
